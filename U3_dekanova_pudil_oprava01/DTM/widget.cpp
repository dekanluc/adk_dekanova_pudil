...
void Widget::on_pushButton_6_clicked()
{
    ...
    Algorithms alg;
    std::vector<QPoint3D> points_1;

    if (ui->comboBox_3->currentIndex() == 0)
        points_1 = alg.generateHill(n, height, width);
    else if(ui->comboBox_3->currentIndex() == 1)
        points_1 = alg.generateRidge(n, height, width);
    else if(ui->comboBox_3->currentIndex() == 2)
        points_1 = alg.generateValley(n, height, width);
    else if(ui->comboBox_3->currentIndex() == 3)
        points_1 = alg.generateSettling(n, height, width);

    ui->Canvas->setPoints(points_1);
    repaint();
}
